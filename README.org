...
* Corral
Corral is a lightweight package that enables quick wrapping of parentheses and other delimiters around text, with intuitive behavior that surrounds exactly the right amount using just two commands.
