...
* Corral
Corral is a lightweight package that lets you quickly wrap parentheses and other delimiters around text, with intuitive behavior that surrounds what you want it to using just two commands.
